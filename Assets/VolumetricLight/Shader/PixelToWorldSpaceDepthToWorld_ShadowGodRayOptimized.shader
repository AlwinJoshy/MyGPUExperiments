...
Shader "PixelToWorldSpace/DepthShadow&GodRayOptimized"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed depthColorSample = tex2D(SHADOW_CAMERA_TOTAL, cameraPos.xy).w;
        ...
        Pass
        {
            ...
            #pragma vertex vert
            #pragma fragment frag
            fixed _CorrectionOffset, _DitherCtrl, _FogCtrl, _TestCtrl, _GlowPower, _Exponential;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                for(int i = 1; i < 64; i++){
                    ...
                    fixed pointDepth = OrthoZ2EyeDepth(1 - depthColorSample.w);
                ...
                // z depth of point from camera
                    ...
                    if(SquareMagnitude(wLerpPos.xyz) < pow(20,2 ))sigmaFog += (isOverShade * _FogCtrl * strideFogdencity * _FogColor) + ((1 - isOverShade) * depthColorSample.xyz * _GlowPower * strideFogdencity);
                }
