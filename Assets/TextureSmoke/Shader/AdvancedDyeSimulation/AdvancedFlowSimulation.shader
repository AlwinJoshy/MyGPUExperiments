Shader "Unlit/Advanced/FlowSimulation"
{
	Properties
	{
		_MainTex("Texture", 2D) = "white" {}
		_FlowMask("Flowmask", 2D) = "black" {}
		...
		SubShader
		{
			...
			Pass
			{
				...
				//	myBit.zw *= 1 - step(tex2D(_FlowMask, i.uv).a, 0.1);
					myBit.z = saturate(tex2D(_FlowMask, i.uv).a);
